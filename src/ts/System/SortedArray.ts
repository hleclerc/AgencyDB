import CmpInterface from "./CmpInterface";

/** Replaces Map<> for type that need comparison surdef
 * good for search. Bad for insertion
 */
export default
class SortedArray<T extends CmpInterface> {
