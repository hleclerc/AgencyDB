...
class OtMerger {
    ...
    constructor( ot_wrapper: OtWrapper, patch_manager: PatchManager ) {
        this.ot_wrapper    = ot_wrapper;
        this.patch_manager = patch_manager;
        this.cq_new        = new BinaryWriter;
        this.cq_unk        = new BinaryWriter;
    }

    glo_to_loc( data: BinaryWriter, input: Uint8Array, src_dev: DevId, src_usr: UsrId, cur_dev: DevId, cur_usr: UsrId ): boolean {
