...
class VectorClock {
    constructor() {
        this.map    = new Map<string,number>(); // DevId (using .val which is of native type string) { PT num
        this.merges = new Array<Inode>(); // DevId (using .val which is of native type string) { PT num
    }
