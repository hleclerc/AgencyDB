...
unsigned HPIPE_DEFINITION_PREFIX HPIPE_PARSE_FUNC_NAME( HPIPE_ADDITIONAL_ARGS HPIPE_BUFF_T *buf, bool last_buf, const HPIPE_CHAR_T *data, const HPIPE_CHAR_T *end_m1 ) {
  ...
  l_91:
    if ( __builtin_expect( data[ 0 ] == 0, 0 ) ) goto l_92;
    if ( data[ 0 ] == 1 ) goto l_90;
    if ( data[ 0 ] != 'G' ) goto l_83;
  l_2:
    if ( data >= end_m1 ) goto c_2;
    ++data;
  l_93:
    if ( data[ 0 ] != 'E' ) goto l_83;
  l_3:
    if ( data >= end_m1 ) goto c_3;
    ++data;
  l_94:
    if ( data[ 0 ] != 'T' ) goto l_83;
  l_4:
  ...
  l_7:
    ...
    ++data;
  l_98:
    if ( data[ 0 ] != 'a' ) goto l_83;
  l_8:
    if ( data >= end_m1 ) goto c_9;
    ++data;
  l_99:
    if ( data[ 0 ] != 'v' ) goto l_83;
  l_9:
    if ( data >= end_m1 ) goto c_10;
    ++data;
  l_100:
    if ( data[ 0 ] != 'i' ) goto l_83;
  l_10:
    if ( data >= end_m1 ) goto c_11;
    ++data;
  l_101:
    if ( data[ 0 ] != 'c' ) goto l_83;
  l_11:
    if ( data >= end_m1 ) goto c_12;
    ++data;
  l_102:
    if ( data[ 0 ] != 'o' ) goto l_83;
  l_12:
    if ( data >= end_m1 ) goto c_13;
    ++data;
  l_103:
    if ( data[ 0 ] != 'n' ) goto l_83;
  l_13:
  ...
  l_113:
    ...
    if ( __builtin_expect( data[ 0 ] >= 128, 0 ) ) goto l_114;
  ...
  l_49:
    ...
    ++data;
  l_139:
    if ( data[ 0 ] != 'e' ) goto l_89;
  l_50:
    if ( data >= end_m1 ) goto c_54;
    ++data;
  l_140:
    if ( data[ 0 ] != 'c' ) goto l_89;
  l_51:
  ...
  l_54:
    ...
    ++data;
  l_144:
    if ( data[ 0 ] != 'b' ) goto l_89;
  l_55:
    if ( data >= end_m1 ) goto c_59;
    ++data;
  l_145:
    if ( data[ 0 ] != 'S' ) goto l_89;
  l_56:
    if ( data >= end_m1 ) goto c_60;
    ++data;
  l_146:
    if ( data[ 0 ] != 'o' ) goto l_89;
  l_57:
  ...
  l_80:
    ...
    ++data;
  l_173:
    if ( data[ 0 ] >= 2 ) goto l_83;
    if ( data[ 0 ] == 1 ) goto l_90;
  l_92:
    { HPIPE_DATA.__PI32_0 = 0; HPIPE_DATA.__PI32_1 = 0; }
  l_81:
    if ( data >= end_m1 ) goto c_85;
    ++data;
  l_174:
    if ( data[ 0 ] >= 128 ) goto l_175;
    ...
    { HPIPE_DATA.__PI32_0 = 0; HPIPE_DATA.__PI32_1 = 0; }
  l_82:
    if ( data >= end_m1 ) goto c_87;
    ++data;
  l_177:
    if ( data[ 0 ] >= 128 ) goto l_178;
    { HPIPE_DATA.__PI32_0 += PI32( *data       ) << HPIPE_DATA.__PI32_1; }
  ...
  e_21:
    ...
    goto l_89;
  c_22:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_111; } }
    if ( last_buf ) goto l_84;
  ...
  e_51:
    ...
    goto l_138;
  c_52:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_88; } }
    if ( last_buf ) goto l_84;
  ...
  e_67:
    ...
    goto l_153;
  c_68:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_154; } }
    if ( last_buf ) goto l_84;
  ...
  e_68:
    ...
    goto l_154;
  c_69:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_155; } }
    if ( last_buf ) goto l_84;
  ...
  e_70:
    ...
    goto l_156;
  c_71:
    while ( buf->next ) { HPIPE_BUFF_T__INC_REF_N( buf, 0 ); buf = buf->next; if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_157; } }
    if ( last_buf ) goto l_84;
    HPIPE_DATA.pending_buf = buf;
  ...
  e_79:
    ...
    goto l_166;
  c_80:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_167; } }
    if ( last_buf ) goto l_84;
  ...
  e_80:
    ...
    goto l_167;
  c_81:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_168; } }
    if ( last_buf ) goto l_84;
  ...
  e_82:
    ...
    goto l_169;
  c_83:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_171; } }
    if ( last_buf ) goto l_84;
  ...
  e_83:
    ...
    goto l_171;
  c_84:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_173; } }
    if ( last_buf ) goto l_83;
  ...
  e_84:
    ...
    goto l_173;
  c_85:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_174; } }
    if ( last_buf ) goto l_84;
  ...
  e_85:
    ...
    goto l_174;
  c_87:
    while ( buf->next ) { HPIPE_BUFF_T *old = buf; buf = buf->next; HPIPE_BUFF_T__DEC_REF( old ); if ( buf->used ) { data = buf->data; end_m1 = buf->data + buf->used - 1; goto l_177; } }
    if ( last_buf ) goto l_84;
    HPIPE_DATA.inp_cont = &&e_87;
    return RET_CONT;
  e_87:
    if ( data > end_m1 ) goto c_87;
    goto l_177;
